## best.R is a function that takes as arguments the state and the outcome of their care programs
## for a number of diseases. The function returns the hospital that has the lowest mortality
## rates in a given state and for a certain pathology (disease)
